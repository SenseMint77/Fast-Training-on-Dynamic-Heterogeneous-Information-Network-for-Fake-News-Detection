...
#            print(h_o.size())
        ...
        # print(3*N, s_input.shape, 2*self.out_features)
        # a = s_input.shape[0]*s_input.shape[1]/2*self.out_features
        if s_input.shape[1] == 32:
            s_input = s_input.view(2*N,2*self.out_features)
        else:
